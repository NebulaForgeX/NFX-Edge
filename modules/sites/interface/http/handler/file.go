...
func (h *FileHandler) Download(c fiber.Ctx) error {
	...
	if err != nil {
		if os.IsPermission(err) {
			return fiberx.ErrorFromErrx(c, sitesErr.ErrInvalidPath)
		}
		return fiberx.ErrorFromErrx(c, sitesErr.ErrFileNotFound)
	}
...
func (h *FileHandler) ExportSingle(c fiber.Ctx) error {
	...
	var req reqdto.FileExportSingleRequestDTO
...
func (h *FileHandler) Delete(c fiber.Ctx) error {
	...
	var req reqdto.FileDeleteRequestDTO
	if err := c.Bind().Body(&req); err != nil {
		return err
	}
