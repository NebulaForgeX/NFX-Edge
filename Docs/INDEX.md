...
欢迎使用 NFX-Edge 文档！本文档提供了所有可用文档的索引和快速导航。
...
- [Traefik 配置](../traefik.yml) - Traefik 静态配置
- [Nginx 配置](../nginx.conf) - Nginx 配置文件
...
4. 阅读 [README.md](README.md) 了解如何添加新网站

### 开发者

1. 阅读 [STRUCTURE.md](STRUCTURE.md) 了解项目结构
2. 阅读 [README.md](README.md) 了解如何添加新网站
3. 参考配置文件进行自定义配置
